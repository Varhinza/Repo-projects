	...
	foreach ($wisata->result_array() as $row){
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container pr-5 ml-5">
				<h1 class="display-4"><?php echo $row['nm_wst']?></h1>
		...
		<div class="row justify-content-center">
			<div class="col-md-8 " >
				<img src="<?php echo base_url('/upload/wisata/'); echo $row['foto']; ?>"  class="card-img-top">
				...
				<div class="btn-group" role="group" aria-label="Basic example">
					<a href="<?php echo base_url('wisata/list_wisata/'); ?>" class="btn btn-primary text-right">Kembali</a>
				</div>
			</div>
			<?php }?>
			<div class="col-md-3">
