...
<?php
	...
	<div class="jumbotron jumbotron-fluid">
        <div class="container pr-5 ml-5">
            <h1 class="display-4"><?php echo $row['nm_ako']?></h1>
	...
	<div class="row justify-content-center">
		<div class="col-md-8 " >
			...
			<div class="btn-group" role="group" aria-label="Basic example">
				<a href="<?php echo base_url('akomodasi/list_jns_akomodasi/');  echo $row['id_jns_ako']; ?>" class="btn btn-primary text-right">Back</a>
			</div>
		</div>
		<?php }?>
		<div class="col-md-3">
