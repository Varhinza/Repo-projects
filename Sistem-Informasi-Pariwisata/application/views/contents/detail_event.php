...
<div class="jumbotron jumbotron-fluid">
          <div class="container pr-5 ml-5">
            <h1 class="display-4"><?php echo $row['nm_eve']?></h1>
	...
	<div class="row justify-content-center">
		<div class="col-md-8 " >
			<img src="<?php echo base_url('/upload/events/'); echo $row['foto']; ?>"  class="card-img-top">
			...
			<div class="btn-group" role="group" aria-label="Basic example">
				<a href="<?php echo base_url('beranda/events/');  ?>" class="btn btn-primary text-right">Back</a>
			</div>
		</div>
		<?php }?>
		<div class="col-md-3">
